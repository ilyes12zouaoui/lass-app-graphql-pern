...
<body class="body" style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#fff; -webkit-text-size-adjust:none;">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#fff">
		<tr>
            ...
            <tr>
									<td class="td" style="box-shadow: 0px 0px 23px -5px rgba(0,0,0,0.4);width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;
									border-style: solid;
									border-width: 1px;
									border-color: #21ade4;">
										...
										<tr>
												...
												<table width="300px" border="0" align="center" bgcolor="#fff" cellspacing="0" cellpadding="0" dir="rtl" style="direction: rtl;width:300px">
												<tr>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="content" style="padding:30px 50px;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="text-white pb15" style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px; line-height:20px; text-transform:uppercase; text-align:center; padding-bottom:15px;">Welcome</td>
																	</tr>
																	<tr>
