  ...
  return (
    <div>
      ...
      <div className={style["profile-information-lane"]}>
        <FontAwesomeIcon icon={faEnvelope} className="color-pink" size="1x" />
      ...
      <div className={style["profile-information-lane"]}>
        <FontAwesomeIcon icon={faVenusMars} className="color-pink" size="1x" />
        <span className={style["profile-information-lane-span"]}>
          {" "}
          {sexe.toLowerCase()}
        </span>
      ...
      <div className={style["profile-information-lane"]}>
        <FontAwesomeIcon icon={faPhone} className="color-pink" size="1x" />
        <span className={style["profile-information-lane-span"]}>
